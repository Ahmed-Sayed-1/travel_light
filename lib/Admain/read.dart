...
import 'package:travel_light/screens/DestinationScreen.dart';
import '../login.dart';
import 'dell.dart';

class etUserName extends StatelessWidget {
                            ...
                            return GestureDetector(
                              onTap: () => Navigator.push(
                                ...
                                MaterialPageRoute(
                                  ...
                                  builder: (_) => DestinationScreen(doc['name'],doc['description']),
                                ),
                              ),
                              child: Card(
                                color: Colors.white,
